...
export const SURVEY_DESCRIPTION_DATA = [
    'вести переговоры с заказчиком, участвовать в Presale встречах;',
    'выявлять требования заказчика, анализировать существующие бизнес-процессы и IT-инфраструктура клиента;',
    'составлять план работы над проекты;',
];
